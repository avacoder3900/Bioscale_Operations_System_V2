...
<div class="mx-auto max-w-5xl space-y-6 p-4">
	<div class="flex items-center justify-between">
		...
		<div class="flex gap-2">
			...
			{/if}
			<a
				href="/spu/cartridges/export?format=usage_log&cartridgeId={c.id}"
				class="tron-button"
					...
					<div class="space-y-2 text-sm">
						...
						<div class="flex justify-between">
							...
							{#if data.firmwareStatus.assayId}
								<a
									href="/spu/assays/{data.firmwareStatus.assayId}"
						...
						{#if data.firmwareStatus.testResultId}
							<div class="flex justify-between">
								...
								<a
									href="/spu/test-results/{data.firmwareStatus.testResultId}"
									style="color: var(--color-tron-cyan, #00ffff)"
								>
