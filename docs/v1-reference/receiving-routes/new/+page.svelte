		...
		<div class="space-y-4">
			...
			{:else if !ipRevision}
				<div class="tron-card p-6">
					...
					<a
						href="/spu/parts/{selectedPart?.id}"
			...
			<div class="space-y-4">
				...
				<div class="grid gap-4 md:grid-cols-2">
							...
							use:enhance={() => {
								...
								return async ({ result }) => {
									...
									if (result.type === 'success') {
										...
										overrideError = data?.overrideError ?? 'Override validation failed';
									}
								};
							}}
						>
					...
					<div class="tron-card p-4">
						...
						<p class="tron-text-muted mb-4 text-sm">
							Reject this lot. It will be sent to Rejected Inventory for tracking. Inventory will NOT be updated.
						</p>
		...
		<div class="space-y-4">
			...
			>
				...
				{#if rejecting}
					...
					<input type="hidden" name="rejectionNextSteps" value={rejectionNextSteps} />
				{/if}
	...
	{:else if step === 5}
		...
		<div class="tron-card p-8 text-center">
			...
			<div class="flex justify-center gap-3">
				<!-- eslint-disable-next-line svelte/no-navigation-without-resolve -->
				<a href="/spu/lots/{createdLotId}" class="tron-button px-4 py-2 text-sm">View Lot</a>
				<!-- eslint-disable-next-line svelte/no-navigation-without-resolve -->
				<a href="/spu/receiving/new" class="tron-text-muted px-4 py-2 text-sm hover:underline"
					>Receive Another</a
				>
			</div>
		</div>
