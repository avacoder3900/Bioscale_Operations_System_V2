...
{:else}
	...
	<div class="space-y-6">
		...
		<div class="flex items-center gap-4">
			...
			<a href="/equipment/temperature-probes/settings"
				class="rounded-lg border border-[var(--color-tron-cyan)]/50 bg-[var(--color-tron-cyan)]/10 px-4 py-2 text-sm font-medium text-[var(--color-tron-cyan)] hover:bg-[var(--color-tron-cyan)]/20 transition-colors flex items-center gap-2">
