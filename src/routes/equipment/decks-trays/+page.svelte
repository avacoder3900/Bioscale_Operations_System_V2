					...
					<div class="flex items-center justify-between p-4">
						<div class="flex-1">
							<div class="flex items-center gap-3">
								...
								<a href="/equipment/decks-trays/deck?id={deck.deckId}" class="font-mono text-sm font-semibold text-[var(--color-tron-cyan)] hover:underline">{deck.deckId}</a>
						...
						<div class="flex items-center gap-2">
							...
							{/if}
							<!-- eslint-disable svelte/no-navigation-without-resolve -->
							<a href="/equipment/decks-trays/deck?id={deck.deckId}" class="rounded p-1 text-[var(--color-tron-text-secondary)] hover:text-[var(--color-tron-cyan)]">
							<!-- eslint-enable svelte/no-navigation-without-resolve -->
				...
				<div class="rounded-lg border border-l-4 border-[var(--color-tron-border)] bg-[var(--color-tron-surface)] {cardBorderClass(tray.status)}">
					...
					<div class="flex items-center justify-between p-4">
						<div class="flex-1">
							<div class="flex items-center gap-3">
								<!-- eslint-disable svelte/no-navigation-without-resolve -->
								<a href="/equipment/decks-trays/tray?id={tray.trayId}" class="font-mono text-sm font-semibold text-[var(--color-tron-cyan)] hover:underline">{tray.trayId}</a>
								<!-- eslint-enable svelte/no-navigation-without-resolve -->
						...
						<div class="flex items-center gap-2">
							...
							{/if}
							<!-- eslint-disable svelte/no-navigation-without-resolve -->
							<a href="/equipment/decks-trays/tray?id={tray.trayId}" class="rounded p-1 text-[var(--color-tron-text-secondary)] hover:text-[var(--color-tron-cyan)]">
							<!-- eslint-enable svelte/no-navigation-without-resolve -->
								<svg class="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7" /></svg>
							</a>
						</div>
