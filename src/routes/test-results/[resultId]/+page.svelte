					...
					<div class="flex justify-between">
						...
						<dd>
							{#if data.result.assayId}
								<a href="/assays/{data.result.assayId}" class="font-mono" style="color: var(--color-tron-cyan, #00ffff)">
									{data.result.assayId}
								</a>
							{:else}
					...
					<div class="flex justify-between">
						...
						<dd>
							{#if data.result.deviceId}
								<a href="/devices/{data.result.deviceId}" class="font-mono" style="color: var(--color-tron-cyan, #00ffff)">
