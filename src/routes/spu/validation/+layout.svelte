<script lang="ts">
	...
	// Only the Thermocouple step exists on master today; magnetometer/spectrophotometer
	// pages are not ported yet, so they are intentionally omitted to avoid dead tabs.
	const navItems = [
		{
