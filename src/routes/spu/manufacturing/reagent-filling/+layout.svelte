<script lang="ts">
	...
	const BASE = '/spu/manufacturing/reagent-filling';
...
<div class="space-y-4">
	<nav class="flex items-center gap-2 text-sm">
		...
		<a
			href={resolve('/spu/manufacturing/opentrons')}
			class="text-[var(--color-tron-text-secondary)] transition-colors hover:text-[var(--color-tron-cyan)]"
		>
			Opentrons
		</a>
	...
	<div class="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
		...
		<nav class="flex items-center gap-1">
			<a href={resolve('/spu/manufacturing/reagent-filling')} class={navLinkClass(BASE, true)}>
				Run Wizard
			</a>
			<a
				href={resolve('/spu/manufacturing/reagent-filling/cooling-queue')}
				class={navLinkClass(`${BASE}/cooling-queue`)}
			>
				Cooling Queue
			</a>
			<a
				href={resolve('/spu/manufacturing/reagent-filling/settings')}
