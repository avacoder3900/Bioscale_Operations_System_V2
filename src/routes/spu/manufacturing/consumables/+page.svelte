...
<div class="space-y-6">
	...
	<div>
		<div class="mb-3 flex items-center justify-between">
			...
			<div class="flex items-center gap-2">
				<a href="/spu/receiving" class="rounded border border-[var(--color-tron-cyan)]/40 px-3 py-1.5 text-xs text-[var(--color-tron-cyan)] hover:bg-[var(--color-tron-cyan)]/10">ROG (Receiving) →</a>
				<a href="/spu/parts" class="rounded border border-[var(--color-tron-border)] px-3 py-1.5 text-xs text-[var(--color-tron-text-secondary)] hover:text-[var(--color-tron-text)]">Manage Parts →</a>
			</div>
		</div>
	...
	<div>
		...
		<p class="mb-3 text-xs text-[var(--color-tron-text-secondary)]">
			All inventory should come in through <a href="/spu/receiving" class="text-[var(--color-tron-cyan)] hover:underline">ROG (Receiving)</a>.
