	...
	{#if !previewParam && !effectiveHasActiveRun && data.robotBlocked}
		...
		<div class="space-y-6 py-8">
			<div class="rounded-lg border border-amber-500/50 bg-amber-900/20 p-6 text-center">
				...
				<a href="/spu/manufacturing/reagent-filling?robot={data.robotId}" class="mt-3 inline-block rounded border border-amber-500/50 px-4 py-2 text-sm text-amber-300 hover:bg-amber-900/30">
