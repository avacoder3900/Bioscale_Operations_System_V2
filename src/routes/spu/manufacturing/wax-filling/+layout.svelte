<script lang="ts">
	...
	const BASE = '/spu/manufacturing/wax-filling';
...
<div class="space-y-4">
	...
	<div class="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
		...
		<nav class="flex items-center gap-1">
			<a href={resolve('/spu/manufacturing/wax-filling')} class={navLinkClass(BASE, true)}>
				Run Wizard
			</a>
			<a
				href={resolve('/spu/manufacturing/wax-filling/oven-queue')}
				class={navLinkClass(`${BASE}/oven-queue`)}
			>
				Oven Queue
			</a>
			<a
				href={resolve('/spu/manufacturing/wax-filling/settings')}
