	...
	const navGroups: NavGroup[] = [
		...
		},
		{
			...
			items: [
				...
				{ href: '/spu/inventory/fridge-storage', label: 'Fridge Storage', icon: 'M6 2h12a1 1 0 011 1v18a1 1 0 01-1 1H6a1 1 0 01-1-1V3a1 1 0 011-1zm0 12h12M10 6h1' },
