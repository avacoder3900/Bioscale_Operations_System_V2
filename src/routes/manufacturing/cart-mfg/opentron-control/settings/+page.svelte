						...
						{:else}
							<div class="grid grid-cols-1 gap-2 sm:grid-cols-2">
								{#each sets as s (s._id)}
									<div class="relative">
										<a
											href={`/manufacturing/cart-mfg/opentron-control/settings/scanner-positions/${s._id}`}
										...
										<form
											method="POST"
											action={`/manufacturing/cart-mfg/opentron-control/settings/scanner-positions/${s._id}?/deleteSet`}
