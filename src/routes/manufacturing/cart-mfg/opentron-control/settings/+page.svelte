...
<div class="mx-auto max-w-5xl space-y-8 p-4">
	...
	<section class="rounded-lg border border-[var(--color-tron-cyan)]/30 bg-[var(--color-tron-surface)]/40 p-5">
		<div class="mb-4 flex items-center justify-between">
			...
			<a href="/manufacturing/cart-mfg/wax-filling/settings"
	...
	<section class="rounded-lg border border-purple-500/30 bg-purple-900/5 p-5">
		<div class="mb-4 flex items-center justify-between">
			...
			<a href="/manufacturing/cart-mfg/reagent-filling/settings"
	...
	<!-- Barcode scan positions moved under Deck Calibration (2026-08-28) -->
	<section class="rounded-lg border border-[var(--color-tron-border)] p-5">
		<div class="flex items-center justify-between">
			<h2 class="text-lg font-semibold" style="color: var(--color-tron-cyan)">Barcode Scan Positions</h2>
