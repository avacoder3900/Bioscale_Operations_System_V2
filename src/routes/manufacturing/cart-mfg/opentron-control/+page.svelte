...
<div class="mx-auto max-w-7xl space-y-8 p-4">
	<div class="flex items-center justify-between">
		...
		<div class="flex items-center gap-2">
			<a href="/manufacturing/cart-mfg/opentron-control/scanner-test?deviceId=ot2-b07-scanner"
				title="Live scanner heartbeat + trigger test"
			...
			<a href="/manufacturing/cart-mfg/opentron-control/sweeps"
			...
			<a href="/manufacturing/cart-mfg/opentron-control/settings"
				...
				<div class="rounded-lg border p-4 transition-all {robotStatusColor(robot.status)}">
					...
					<div class="mt-3 flex gap-2">
						{#if robot.status === 'available'}
							<a href="/manufacturing/cart-mfg/wax-filling?robot={robot.robotId}"
							...
							<a href="/manufacturing/cart-mfg/reagent-filling?robot={robot.robotId}"
