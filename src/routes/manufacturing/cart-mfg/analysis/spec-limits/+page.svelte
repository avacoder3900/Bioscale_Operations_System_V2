...
<div class="mx-auto max-w-5xl space-y-5 p-4">
	<div class="flex items-center justify-between">
		...
		<a href="/manufacturing/cart-mfg/analysis" class="rounded border border-[var(--color-tron-border)] px-3 py-1.5 text-xs hover:border-[var(--color-tron-cyan)]" style="color: var(--color-tron-text)">← Back to Analysis</a>
	</div>
