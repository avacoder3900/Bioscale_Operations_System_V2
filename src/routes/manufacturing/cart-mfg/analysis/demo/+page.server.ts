/**
 * /manufacturing/cart-mfg/analysis/demo — fabricated-data twin of the real analytics
...
export const actions: Actions = {
	...
	unlock: async ({ request, cookies }) => {
		...
		cookies.set(TRAINING_COOKIE, 'unlocked', {
			path: '/manufacturing/cart-mfg/analysis/demo',
	...
	lock: async ({ cookies }) => {
		cookies.delete(TRAINING_COOKIE, { path: '/manufacturing/cart-mfg/analysis/demo' });
