...
<div class="mx-auto max-w-2xl space-y-4 p-4">
	...
	{:else if target}
		<p class="text-[10px]" style="color: var(--color-tron-text-secondary)">A cart that is currently in a bucket (Barcoded / Unpressed / Pressed / Backed) is removed from its bucket's pass when moved here.</p>
	{/if}
