 ...
 * CV model training off to GitHub-hosted compute that scales to zero.
 *
 * Required env:
 *   GITHUB_DISPATCH_TOKEN  fine-grained PAT — Contents: write + Metadata: read
 *                          on the BIMS repo (stored only in Vercel)
