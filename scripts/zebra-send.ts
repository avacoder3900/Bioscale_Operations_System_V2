 ...
 *          --gap=0.125, --x/--y (dots; default = the calibrated ZT230_2X_075_DEFAULTS), --mag=3, --dark=<0-30>, --dry (print ZPL, don't send)
 */
...
const cfg: ZebraLabelConfig = {
	...
	offsetX: Number(opt('x') ?? ZT230_2X_075_DEFAULTS.offsetX),
	offsetY: Number(opt('y') ?? ZT230_2X_075_DEFAULTS.offsetY),
