 ...
 *   ROBOT=b14 ROBOT_HOST=https://ot2-b14.tailf65a70.ts.net node scripts/deploy-reagent-tipcal-guards.cjs
 *   ROBOT=b14 ROBOT_HOST=tailnet node scripts/deploy-reagent-tipcal-guards.cjs   # same, URL built from ROBOT
